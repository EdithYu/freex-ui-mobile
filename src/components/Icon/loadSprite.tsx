...
const icons: { [key: string]: string } = {
  ...
  xclose:
    '<svg viewBox="0 0 1024 1024" ><path d="M867.648 951.296 512 595.648l-355.648 355.648c-11.52 11.52-30.272 11.52-41.856 0L72.64 909.44c-11.52-11.52-11.52-30.272 0-41.856L428.352 512 72.64 156.352c-11.52-11.52-11.52-30.272 0-41.856l41.856-41.856c11.52-11.52 30.272-11.52 41.856 0L512 428.288l355.648-355.648c11.52-11.52 30.272-11.52 41.856 0l41.856 41.856c11.52 11.52 11.52 30.272 0 41.856L595.648 512l355.648 355.648c11.52 11.52 11.52 30.272 0 41.856l-41.856 41.856C897.984 962.88 879.168 962.88 867.648 951.296L867.648 951.296z" p-id="16478"></path></svg>',
  xleft:
    '<svg viewBox="0 0 1024 1024" ><path d="M783.058824 960L720.112941 1024 258.349176 554.767059a61.168941 61.168941 0 0 1 0-85.534118L720.082824 0 783.058824 64 342.226824 512 783.058824 960z" ></path></svg>',
  xcheck:
    '<svg viewBox="0 0 31 26"><path d="M31,0 L31,10 C31,18.836556 23.836556,26 15,26 L9.09494702e-13,26 L9.09494702e-13,26 C9.07817013e-13,12.3006309 10.6879051,0.980435603 24.3646777,0.193922143 C26.6125372,0.0646341302 28.8243116,0 31,0 Z" id="形状结合" fill="#1D9DFF"></path><path d="M24.9235857,9.67434809 L16.2367756,18.633111 C16.2367756,18.633111 16.2367756,18.633111 16.2302784,18.633111 C16.1198253,18.746513 15.8209522,19 15.4765985,19 C15.2297034,19 14.950322,18.8599151 14.7164214,18.6197696 L11.0779669,14.8841722 C10.974011,14.7774409 10.974011,14.6106731 11.0779669,14.5039418 L12.2344756,13.3165555 C12.2864536,13.2631898 12.351426,13.236507 12.4163984,13.236507 C12.4813708,13.236507 12.5463432,13.2631898 12.5983211,13.3165555 L15.4830957,16.2783505 L23.4097288,8.08004851 C23.4617067,8.02668284 23.5266791,8 23.5916515,8 C23.5916515,8 23.5916515,8 23.5916515,8 C23.6631211,8 23.7280935,8.02668284 23.7735742,8.08004851 L24.9105912,9.28744694 C25.0275416,9.400849 25.0275416,9.56761674 24.9235857,9.67434809 Z" id="Mask" fill="#FFFFFF" fill-rule="nonzero" transform="translate(18.000000, 13.500000) rotate(-9.000000) translate(-18.000000, -13.500000) "></path></svg>',
};
